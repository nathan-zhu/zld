...
class Curl {
    ...
    public static function run($is_get=1, $url, $post=array(), $CA=false, $proxy=false){
        ...
        $arrHeader = array(
            ...
            'Accept-Encoding: gzip, deflate',
            // 'Origin: https://winchendon.myschoolapp.com',
            // 'WH-Version: 11.13.1.32',
            // 'Content-Type: application/json',
            'Accept: application/json, text/javascript, */*; q=0.01',
            // 'Referer: https://winchendon.myschoolapp.com/app/',
        ...
        curl_setopt($curl, CURLOPT_CONNECTTIMEOUT, 6000);
    ...
    public static function run2($is_get=1, $url, $post=array(), $CA=false){
        $cookieFile = dirname(__FILE__).'/cookies/'.parse_url($url)['host'].'.txt';
        $arrHeader = array(
            'Accept-Language: zh-cn',
            'Accept-Encoding:gzip,deflate',
