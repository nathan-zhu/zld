 ...
 */
class Wlhs_Zhaofangchen
{
    const Username = 'zhaogu';
    const Password = 'Fangchen@17';
    const School = 'wlhs';
                ...
                if ($tmpRet) {
                    ...
                    foreach ($tmpRet as $tmpArrData) {
                        $newArrData['detail'][] = array(
                            'GroupName' => str_replace("'", "", $tmpArrData['GroupName']),
                            'Date' => $tmpArrData['CalendarDate'],
                            'Reason' => str_replace("'", "", $tmpArrData['ExcuseDescription']),
                            'Comment' => str_replace("'", "", $tmpArrData['Comment']),
                            'Category' => str_replace("'", "", $tmpArrData['ExcuseCategoryDescription']),
